...
class Game 
{
	...
	private $keys; // holds html for keyboard 
	private $topRowKeys; // holds keys with html tags for 1st row of keyboard to pass to $keys
	private $middleRowKeys; // holds keys with html tags for 2nd row of keyboard to pass to $keys
	private $bottomRowKeys; // holds keys with html tags for 3rd row of keyboard to pass to $keys
